<?php
    ...
    use eTorn\Routes\ProductoRoutes;
    use eTorn\Routes\ProductoTiposRoutes;
    use eTorn\Routes\EspacioRoutes;
    use eTorn\Routes\TiketRoutes;
    use eTorn\Routes\TiketItemRoutes;
  ...
  //  DashboardRoutes::manageRoutes($router);
    ...
    ProductoRoutes::manageRoutes($router);
    ProductoTiposRoutes::manageRoutes($router);
    EspacioRoutes::manageRoutes($router);
    TiketRoutes::manageRoutes($router);
    TiketItemRoutes::manageRoutes($router);
